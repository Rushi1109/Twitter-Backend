...
import { createTweet, deleteTweet, getLastNTweetsOfUser, getTweet } from "../../controllers/tweet-controller.js";
...
router.route('/user/tweets').get(authenticate, getLastNTweetsOfUser);
